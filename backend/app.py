...
for attempt in range(max_retries):
    try:
        ...
        print(f"Base de datos no lista, intentando {attempt + 1}/{max_retries}...")
        time.sleep(2)
else:
    print("Fallo de conexión con la Base de Datos después de muchos intentos.")
    exit(1)
